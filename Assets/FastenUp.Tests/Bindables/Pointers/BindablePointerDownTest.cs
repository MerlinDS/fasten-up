...
{
    [TestFixture]
    [TestOf(typeof(BindablePointerDown))]
    public class BindablePointerDownTest
    {
        [Test]
        ...
        private static BindablePointerDown CreateSut() => 
            new GameObject().AddComponent<BindablePointerDown>();
    }
}