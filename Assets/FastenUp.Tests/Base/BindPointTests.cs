...
namespace FastenUp.Tests.Base
{
    ...
    {
        [Test]
        public void Add_When_bindable_was_not_added_Should_set_value_and_subscribe_to_bindable()
        {
            //Arrange
        ...
        [Test]
        public void Remove_When_bindable_was_added_Should_unsubscribe_from_bindable()
        {
            //Arrange
            var bindable = Substitute.For<IBindable<bool>>();
            var sut = new BindPoint<bool>();
        ...
        [Test]
        public void OnValueChanged_When_bindable_value_changed_Should_update_value_and_invoke_event()
        {
            //Arrange
            var bindable = Substitute.For<IBindable<bool>>();
